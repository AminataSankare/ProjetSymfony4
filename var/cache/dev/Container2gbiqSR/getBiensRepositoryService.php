...
// Returns the private 'App\Repository\BiensRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/BiensRepository.php';

return $this->privates['App\Repository\BiensRepository'] = new \App\Repository\BiensRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
