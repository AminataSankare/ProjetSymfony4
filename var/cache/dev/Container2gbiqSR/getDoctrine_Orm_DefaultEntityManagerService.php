...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\BiensRepository' => function () {
    return ($this->privates['App\Repository\BiensRepository'] ?? $this->load('getBiensRepositoryService.php'));
}))));
